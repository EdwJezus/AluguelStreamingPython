...
############ Cadastrar Filme
  ...
  if quest == '1':
    ...
    if diretor_associado:
        ##filme1 = Filme(titulo1, ano1, genero1, preco1, diretor_associado, duracao1)
        filme1 = Filme(titulo1, ano1, genero1, preco1, diretor_associado, duracao1)
        ##filmes.append(filme1)
